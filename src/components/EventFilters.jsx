...
import { SERVICE_TYPE_OPTIONS } from '../hooks/useEventFilters'

// Renders the filter bar driven by useEventFilters' return value --
// spread it straight in: <EventFilters {...filters} />
  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, alignItems: 'center', marginBottom: 20 }}>
      <div style={{ position: 'relative', flex: '1 1 200px', minWidth: 180 }}>
        ...
        <input className="form-control" style={{ paddingLeft: 32 }} placeholder="Buscar en eventos..."
      ...
      <select className="form-control form-control-select" style={{ maxWidth: 160 }}
        value={serviceTypeFilter} onChange={e => setServiceTypeFilter(e.target.value)}>
